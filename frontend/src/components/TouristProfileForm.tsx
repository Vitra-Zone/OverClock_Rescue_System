    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <label className="space-y-2">
          <span className="text-xs uppercase tracking-[0.2em] text-crisis-muted">Tourist first name</span>
        ...
        <label className="space-y-2">
          <span className="text-xs uppercase tracking-[0.2em] text-crisis-muted">Tourist last name</span>
      ...
      <div className="grid grid-cols-[auto_1fr] gap-2 items-end">
        <div className="space-y-2">
          <span className="text-xs uppercase tracking-[0.2em] text-crisis-muted">Phone</span>
          <div className="form-input w-16 text-center text-crisis-text-dim">+91</div>
        </div>
        <label className="space-y-2 block">
          <span className="text-xs uppercase tracking-[0.2em] text-crisis-muted">Mobile number</span>
      ...
      <label className="space-y-2 block">
        <span className="text-xs uppercase tracking-[0.2em] text-crisis-muted">Aadhaar number</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <label className="space-y-2 block">
          <span className="text-xs uppercase tracking-[0.2em] text-crisis-muted">Home state</span>
        ...
        <label className="space-y-2 block">
          <span className="text-xs uppercase tracking-[0.2em] text-crisis-muted">Home district</span>
      ...
      <label className="space-y-2 block">
        <span className="text-xs uppercase tracking-[0.2em] text-crisis-muted">Pin code</span>
      ...
      {profile && (
        <div className="rounded-2xl border border-crisis-border/60 bg-crisis-bg/60 p-4 text-sm text-crisis-text-dim space-y-1">
          <p><span className="text-crisis-text">Digital ID:</span> {profile.digitalId}</p>
          <p><span className="text-crisis-text">Serial:</span> {String(profile.serialNumber).padStart(2, '0')}</p>
        </div>
      )}
