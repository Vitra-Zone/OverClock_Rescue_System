...
import { updateTouristProfile } from '@overclock/shared/api';
    ...
    <div className="min-h-screen px-4 py-8">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="card p-6 sm:p-8">
          <div className="mb-6">
            <p className="text-xs uppercase tracking-[0.25em] text-slate-400 mb-1">Profile editor</p>
            <h1 className="text-3xl font-black text-white">Edit tourist profile</h1>
          </div>
